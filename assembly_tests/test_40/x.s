...
movq 272(%rsp), 288(%rsp)
movq $8, 296(%rsp)
movq 296(%rsp), 304(%rsp)
addq 288(%rsp), 304(%rsp)
movq 304(%rsp), 312(%rsp)
movq 312(%rsp), 320(%rsp)
movq 312(%rsp), 328(%rsp)
movq $8, 336(%rsp)
movq 336(%rsp), 344(%rsp)
addq 328(%rsp), 344(%rsp)
movq 344(%rsp), 352(%rsp)
movq 352(%rsp), 360(%rsp)
movq 312(%rsp), 368(%rsp)
movq 368(%rsp), 376(%rsp)
addq 360(%rsp), 376(%rsp)
movq 376(%rsp), 384(%rsp)
addq 320(%rsp), 384(%rsp)
movq 384(%rsp), 392(%rsp)
addq 280(%rsp), 392(%rsp)
movq 392(%rsp), 400(%rsp)
addq 240(%rsp), 400(%rsp)
movq 400(%rsp), 408(%rsp)
addq 200(%rsp), 408(%rsp)
movq 408(%rsp), 416(%rsp)
addq 160(%rsp), 416(%rsp)
movq 416(%rsp), 424(%rsp)
addq 120(%rsp), 424(%rsp)
movq 424(%rsp), 432(%rsp)
addq 80(%rsp), 432(%rsp)
movq 432(%rsp), 440(%rsp)
addq 40(%rsp), 440(%rsp)
movq 440(%rsp), %rax
jmp end
end:
